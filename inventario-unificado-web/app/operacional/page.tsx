 ...
 * O que faz: Normaliza entradas na funcao 'formatSupplyLevel', reduzindo ambiguidade antes da regra principal.
 * Entradas: Parametros esperados: level; com validacao de formato e fallback quando necessario.
