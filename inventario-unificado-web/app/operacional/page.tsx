...
export default async function OperacionalPage() {
  ...
  return (
    <main style={{ padding: 24, fontFamily: "sans-serif" }}>
      <h1>Impressoras - Visao Operacional</h1>
      <p>Fonte: API/servicos reais (Supabase).</p>
        ...
        >
          <thead>
            <tr>
              ...
              <th style={{ borderBottom: "1px solid #ccc", textAlign: "left", padding: 8 }}>Paginas</th>
              <th style={{ borderBottom: "1px solid #ccc", textAlign: "left", padding: 8 }}>Menor suprimento</th>
              <th style={{ borderBottom: "1px solid #ccc", textAlign: "left", padding: 8 }}>Ultimo visto</th>
            </tr>
          </thead>
          <tbody>
